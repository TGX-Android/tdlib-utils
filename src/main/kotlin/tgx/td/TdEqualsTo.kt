...
@Autogenerated
fun Array<Array<PageBlockTableCell>>?.equalsTo(other: Array<Array<PageBlockTableCell>>?): Boolean = 
  this.contentEqualsOrEmpty(other, Array<PageBlockTableCell>::equalsTo)

@Autogenerated
fun Array<CallServer>?.equalsTo(other: Array<CallServer>?): Boolean = 
  this.contentEqualsOrEmpty(other, CallServer::equalsTo)
...
@Autogenerated
fun Array<GroupCallRecentSpeaker>?.equalsTo(other: Array<GroupCallRecentSpeaker>?): Boolean = 
  this.contentEqualsOrEmpty(other, GroupCallRecentSpeaker::equalsTo)

@Autogenerated
fun Array<GroupCallVideoSourceGroup>?.equalsTo(other: Array<GroupCallVideoSourceGroup>?): Boolean = 
  this.contentEqualsOrEmpty(other, GroupCallVideoSourceGroup::equalsTo)
...
@Autogenerated
fun Array<MessageSender>?.equalsTo(other: Array<MessageSender>?): Boolean = 
  this.contentEqualsOrEmpty(other, MessageSender::equalsTo)

@Autogenerated
fun Array<PageBlock>?.equalsTo(other: Array<PageBlock>?): Boolean = 
  this.contentEqualsOrEmpty(other, PageBlock::equalsTo)

@Autogenerated
fun Array<PageBlockListItem>?.equalsTo(other: Array<PageBlockListItem>?): Boolean = 
  this.contentEqualsOrEmpty(other, PageBlockListItem::equalsTo)

@Autogenerated
fun Array<PageBlockRelatedArticle>?.equalsTo(other: Array<PageBlockRelatedArticle>?): Boolean = 
  this.contentEqualsOrEmpty(other, PageBlockRelatedArticle::equalsTo)

@Autogenerated
fun Array<PageBlockTableCell>?.equalsTo(other: Array<PageBlockTableCell>?): Boolean = 
  this.contentEqualsOrEmpty(other, PageBlockTableCell::equalsTo)

@Autogenerated
fun Array<RichText>?.equalsTo(other: Array<RichText>?): Boolean = 
  this.contentEqualsOrEmpty(other, RichText::equalsTo)
...
@Autogenerated
fun AccountInfo?.equalsTo(other: AccountInfo?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
    AccountInfo(
  ...
  this.registrationMonth == b.registrationMonth &&
  this.registrationYear == b.registrationYear &&
  this.lastNameChangeDate == b.lastNameChangeDate &&
  this.lastPhotoChangeDate == b.lastPhotoChangeDate &&
  this.phoneNumberCountryCode.equalsOrEmpty(b.phoneNumberCountryCode)
}
...
@Autogenerated
fun Call?.equalsTo(other: Call?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
    Call(
      this.id,
      this.uniqueId,
  ...
  this.isVideo == b.isVideo &&
  this.state.equalsTo(b.state)
}

@Autogenerated
fun CallProtocol?.equalsTo(other: CallProtocol?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
    CallProtocol(
      this.udpP2p,
      this.udpReflector,
  ...
  this.udpP2p == b.udpP2p &&
  this.udpReflector == b.udpReflector &&
  this.minLayer == b.minLayer &&
  this.maxLayer == b.maxLayer &&
  this.libraryVersions.contentEqualsOrEmpty(b.libraryVersions)
}

@Autogenerated
fun CallServer?.equalsTo(other: CallServer?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
    CallServer(
      this.id,
      this.ipAddress,
  ...
  this.id == b.id &&
  this.port == b.port &&
  this.ipAddress.equalsOrEmpty(b.ipAddress) &&
  this.ipv6Address.equalsOrEmpty(b.ipv6Address) &&
  this.type.equalsTo(b.type)
}
...
fun ChatAdministratorRights?.equalsTo(other: ChatAdministratorRights?): Boolean = this.safeEqualsTo(other) { b ->
  ...
  this.canManageTags == b.canManageTags &&
...
fun ChatPermissions?.equalsTo(other: ChatPermissions?): Boolean = this.safeEqualsTo(other) { b ->
  ...
  this.canReactToMessages == b.canReactToMessages &&
  this.canEditTag == b.canEditTag &&
  this.canChangeInfo == b.canChangeInfo &&
  this.canInviteUsers == b.canInviteUsers &&
  this.canPinMessages == b.canPinMessages &&
...
@Autogenerated
fun ChatPhotoInfo?.equalsTo(other: ChatPhotoInfo?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
    ChatPhotoInfo(
      this.small,
      this.big,
  ...
  this.hasAnimation == b.hasAnimation &&
  this.isPersonal == b.isPersonal &&
  this.small.equalsTo(b.small) &&
  this.big.equalsTo(b.big) &&
  this.minithumbnail.equalsTo(b.minithumbnail)
}
...
@Autogenerated
fun Gift?.equalsTo(other: Gift?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
    Gift(
      this.id,
  ...
  this.defaultSellStarCount == b.defaultSellStarCount &&
  this.upgradeStarCount == b.upgradeStarCount &&
  this.upgradeVariantCount == b.upgradeVariantCount &&
  this.hasColors == b.hasColors &&
  this.isForBirthday == b.isForBirthday &&
  this.isPremium == b.isPremium &&
  this.nextSendDate == b.nextSendDate &&
  this.firstSendDate == b.firstSendDate &&
  this.lastSendDate == b.lastSendDate &&
  this.sticker.equalsTo(b.sticker) &&
  this.auctionInfo.equalsTo(b.auctionInfo) &&
  this.userLimits.equalsTo(b.userLimits) &&
  this.overallLimits.equalsTo(b.overallLimits) &&
  this.background.equalsTo(b.background)
}

@Autogenerated
fun GiftAuction?.equalsTo(other: GiftAuction?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
    GiftAuction(
      this.id,
      this.giftsPerRound,
  ...
  this.giftsPerRound == b.giftsPerRound &&
  this.startDate == b.startDate &&
  this.id.equalsOrEmpty(b.id)
}

@Autogenerated
fun GiftBackground?.equalsTo(other: GiftBackground?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
    GiftBackground(
      this.centerColor,
      this.edgeColor,
...
@Autogenerated
fun GiftPurchaseLimits?.equalsTo(other: GiftPurchaseLimits?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
    GiftPurchaseLimits(
      this.totalCount,
      this.remainingCount
...
@Autogenerated
fun GiftResaleParameters?.equalsTo(other: GiftResaleParameters?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
  ...
  this.starCount == b.starCount &&
  this.gramCentCount == b.gramCentCount &&
  this.gramOnly == b.gramOnly
}

@Autogenerated
fun GroupCall?.equalsTo(other: GroupCall?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
    GroupCall(
      this.id,
      this.uniqueId,
      ...
      this.areMessagesAllowed,
      this.canToggleAreMessagesAllowed,
      this.canDeleteMessages,
      this.recordDuration,
  ...
  this.id == b.id &&
  this.uniqueId == b.uniqueId &&
  this.paidMessageStarCount == b.paidMessageStarCount &&
  this.scheduledStartDate == b.scheduledStartDate &&
  this.enabledStartNotification == b.enabledStartNotification &&
  this.isActive == b.isActive &&
  this.isVideoChat == b.isVideoChat &&
  this.isLiveStory == b.isLiveStory &&
  this.isRtmpStream == b.isRtmpStream &&
  this.isJoined == b.isJoined &&
  this.needRejoin == b.needRejoin &&
  this.isOwned == b.isOwned &&
  this.canBeManaged == b.canBeManaged &&
  this.participantCount == b.participantCount &&
  this.hasHiddenListeners == b.hasHiddenListeners &&
  this.loadedAllParticipants == b.loadedAllParticipants &&
  this.isMyVideoEnabled == b.isMyVideoEnabled &&
  this.isMyVideoPaused == b.isMyVideoPaused &&
  this.canEnableVideo == b.canEnableVideo &&
  this.muteNewParticipants == b.muteNewParticipants &&
  this.canToggleMuteNewParticipants == b.canToggleMuteNewParticipants &&
  this.canSendMessages == b.canSendMessages &&
  this.areMessagesAllowed == b.areMessagesAllowed &&
  this.canToggleAreMessagesAllowed == b.canToggleAreMessagesAllowed &&
  this.canDeleteMessages == b.canDeleteMessages &&
  this.recordDuration == b.recordDuration &&
  this.isVideoRecorded == b.isVideoRecorded &&
  this.duration == b.duration &&
  this.title.equalsOrEmpty(b.title) &&
  this.inviteLink.equalsOrEmpty(b.inviteLink) &&
  this.messageSenderId.equalsTo(b.messageSenderId) &&
  this.recentSpeakers.equalsTo(b.recentSpeakers)
}

@Autogenerated
fun GroupCallParticipant?.equalsTo(other: GroupCallParticipant?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
  ...
  this.audioSourceId == b.audioSourceId &&
  this.screenSharingAudioSourceId == b.screenSharingAudioSourceId &&
  this.isCurrentUser == b.isCurrentUser &&
  this.isSpeaking == b.isSpeaking &&
  this.isHandRaised == b.isHandRaised &&
  this.canBeMutedForAllUsers == b.canBeMutedForAllUsers &&
  this.canBeUnmutedForAllUsers == b.canBeUnmutedForAllUsers &&
  this.canBeMutedForCurrentUser == b.canBeMutedForCurrentUser &&
  this.canBeUnmutedForCurrentUser == b.canBeUnmutedForCurrentUser &&
  this.isMutedForAllUsers == b.isMutedForAllUsers &&
  this.isMutedForCurrentUser == b.isMutedForCurrentUser &&
  this.canUnmuteSelf == b.canUnmuteSelf &&
  this.volumeLevel == b.volumeLevel &&
  this.participantId.equalsTo(b.participantId) &&
  this.videoInfo.equalsTo(b.videoInfo) &&
  this.screenSharingVideoInfo.equalsTo(b.screenSharingVideoInfo) &&
  this.bio.equalsOrEmpty(b.bio) &&
  this.order.equalsOrEmpty(b.order)
}

@Autogenerated
fun GroupCallParticipantVideoInfo?.equalsTo(other: GroupCallParticipantVideoInfo?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
  ...
  this.sourceGroups.equalsTo(b.sourceGroups) &&
  this.endpointId.equalsOrEmpty(b.endpointId)
}

@Autogenerated
fun GroupCallRecentSpeaker?.equalsTo(other: GroupCallRecentSpeaker?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
...
@Autogenerated
fun GroupCallVideoSourceGroup?.equalsTo(other: GroupCallVideoSourceGroup?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
  ...
  this.semantics.equalsOrEmpty(b.semantics) &&
  this.sourceIds.contentEqualsOrEmpty(b.sourceIds)
}
...
@Autogenerated
fun Location?.equalsTo(other: Location?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
    Location(
      this.latitude,
      this.longitude,
...
@Autogenerated
fun MessageGroupCall?.equalsTo(other: MessageGroupCall?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
    MessageGroupCall(
      this.uniqueId,
      this.isActive,
  ...
  this.uniqueId == b.uniqueId &&
  this.isActive == b.isActive &&
  this.wasMissed == b.wasMissed &&
  this.isVideo == b.isVideo &&
  this.duration == b.duration &&
  this.otherParticipantIds.equalsTo(b.otherParticipantIds)
}

@Autogenerated
fun MessageLocation?.equalsTo(other: MessageLocation?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
    MessageLocation(
      this.location
    )
...
@Autogenerated
fun PageBlockCaption?.equalsTo(other: PageBlockCaption?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
    PageBlockCaption(
      this.text,
      this.credit
  ...
  this.text.equalsTo(b.text) &&
  this.credit.equalsTo(b.credit)
}

@Autogenerated
fun PageBlockListItem?.equalsTo(other: PageBlockListItem?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
    PageBlockListItem(
      this.label,
      this.blocks,
  ...
  this.hasCheckbox == b.hasCheckbox &&
  this.isChecked == b.isChecked &&
  this.value == b.value &&
  this.label.equalsOrEmpty(b.label) &&
  this.blocks.equalsTo(b.blocks) &&
  this.type.equalsOrEmpty(b.type)
}

@Autogenerated
fun PageBlockRelatedArticle?.equalsTo(other: PageBlockRelatedArticle?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
  ...
  this.title.equalsOrEmpty(b.title) &&
  this.description.equalsOrEmpty(b.description) &&
  this.photo.equalsTo(b.photo) &&
  this.author.equalsOrEmpty(b.author)
}

@Autogenerated
fun PageBlockTableCell?.equalsTo(other: PageBlockTableCell?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
    PageBlockTableCell(
      this.text,
      this.isHeader,
  ...
  this.isHeader == b.isHeader &&
  this.colspan == b.colspan &&
  this.rowspan == b.rowspan &&
  this.text.equalsTo(b.text) &&
  this.align.equalsTo(b.align) &&
  this.valign.equalsTo(b.valign)
}
...
@Autogenerated
fun Proxy?.equalsTo(other: Proxy?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
    Proxy(
      this.server,
      this.port,
...
@Autogenerated
fun RichMessage?.equalsTo(other: RichMessage?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
    RichMessage(
      this.blocks,
      this.isRtl,
...
fun ThemeSettings?.equalsTo(other: ThemeSettings?): Boolean = this.safeEqualsTo(other) { b ->
  ...
  this.baseTheme.equalsTo(b.baseTheme) &&
  this.background.equalsTo(b.background) &&
...
fun UpgradedGift?.equalsTo(other: UpgradedGift?): Boolean = this.safeEqualsTo(other) { b ->
  ...
  this.id == b.id &&
  this.regularGiftId == b.regularGiftId &&
  this.publisherChatId == b.publisherChatId &&
  this.number == b.number &&
  this.totalUpgradedCount == b.totalUpgradedCount &&
  this.maxUpgradedCount == b.maxUpgradedCount &&
  this.isBurned == b.isBurned &&
  this.isCrafted == b.isCrafted &&
  this.isPremium == b.isPremium &&
  this.isThemeAvailable == b.isThemeAvailable &&
  this.usedThemeChatId == b.usedThemeChatId &&
  this.canSendPurchaseOffer == b.canSendPurchaseOffer &&
  this.craftProbabilityPerMille == b.craftProbabilityPerMille &&
  this.valueAmount == b.valueAmount &&
  this.valueUsdAmount == b.valueUsdAmount &&
  this.title.equalsOrEmpty(b.title) &&
  this.name.equalsOrEmpty(b.name) &&
  this.hostId.equalsTo(b.hostId) &&
  ...
  this.resaleParameters.equalsTo(b.resaleParameters) &&
  this.valueCurrency.equalsOrEmpty(b.valueCurrency)
}
...
@Autogenerated
fun UpgradedGiftColors?.equalsTo(other: UpgradedGiftColors?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
    UpgradedGiftColors(
      this.id,
      this.modelCustomEmojiId,
      this.symbolCustomEmojiId,
      this.lightThemeAccentColor,
      this.lightThemeColors,
      this.darkThemeAccentColor,
      this.darkThemeColors
    )
  }
  this.id == b.id &&
  this.modelCustomEmojiId == b.modelCustomEmojiId &&
  this.symbolCustomEmojiId == b.symbolCustomEmojiId &&
  this.lightThemeAccentColor == b.lightThemeAccentColor &&
  this.darkThemeAccentColor == b.darkThemeAccentColor &&
  this.lightThemeColors.contentEqualsOrEmpty(b.lightThemeColors) &&
  this.darkThemeColors.contentEqualsOrEmpty(b.darkThemeColors)
}
...
fun Usernames?.equalsTo(other: Usernames?): Boolean = this.safeEqualsTo(other) { b ->
  ...
  this.collectibleUsernames.contentEqualsOrEmpty(b.collectibleUsernames)
}

@Autogenerated
fun Venue?.equalsTo(other: Venue?): Boolean = this.safeEqualsTo(other) { b ->
  if (COMPILE_CHECK) {
    Venue(
      this.location,
      this.title,
  ...
  this.location.equalsTo(b.location) &&
  this.title.equalsOrEmpty(b.title) &&
  this.address.equalsOrEmpty(b.address) &&
  this.provider.equalsOrEmpty(b.provider) &&
  this.id.equalsOrEmpty(b.id) &&
  this.type.equalsOrEmpty(b.type)
}
...
@Autogenerated
fun BuiltInTheme?.equalsTo(other: BuiltInTheme?): Boolean = this.safeEqualsTo(other) { _ ->
  when (this.constructor) {
    BuiltInThemeArctic.CONSTRUCTOR,
    BuiltInThemeClassic.CONSTRUCTOR,
    BuiltInThemeDay.CONSTRUCTOR,
    BuiltInThemeNight.CONSTRUCTOR,
    BuiltInThemeTinted.CONSTRUCTOR ->
      true // nothing to compare
    else -> {
      assertBuiltInTheme_3dd5c5d2()
      throw unsupported(this)
    }
  }
}
...
@Autogenerated
fun ButtonStyle?.equalsTo(other: ButtonStyle?): Boolean = this.safeEqualsTo(other) { _ ->
  when (this.constructor) {
    ButtonStyleDanger.CONSTRUCTOR,
    ButtonStyleDefault.CONSTRUCTOR,
    ButtonStylePrimary.CONSTRUCTOR,
    ButtonStyleSuccess.CONSTRUCTOR ->
      true // nothing to compare
    else -> {
      assertButtonStyle_da99259d()
      throw unsupported(this)
    }
  }
}
...
@Autogenerated
fun CallDiscardReason?.equalsTo(other: CallDiscardReason?): Boolean = this.safeEqualsTo(other) { b ->
  when (this.constructor) {
    ...
    CallDiscardReasonMissed.CONSTRUCTOR ->
      true // nothing to compare
    CallDiscardReasonUpgradeToGroupCall.CONSTRUCTOR -> {
      require(this is CallDiscardReasonUpgradeToGroupCall && b is CallDiscardReasonUpgradeToGroupCall)
      if (COMPILE_CHECK) {
      ...
      assertCallDiscardReason_241d03d4()
      throw unsupported(this)
    }
  }
}
...
@Autogenerated
fun CallServerType?.equalsTo(other: CallServerType?): Boolean = this.safeEqualsTo(other) { b ->
  when (this.constructor) {
    CallServerTypeTelegramReflector.CONSTRUCTOR -> {
      require(this is CallServerTypeTelegramReflector && b is CallServerTypeTelegramReflector)
      if (COMPILE_CHECK) {
      ...
      this.isTcp == b.isTcp &&
      this.peerTag.contentEqualsOrEmpty(b.peerTag)
    }
    CallServerTypeWebrtc.CONSTRUCTOR -> {
      require(this is CallServerTypeWebrtc && b is CallServerTypeWebrtc)
      if (COMPILE_CHECK) {
      ...
      this.supportsTurn == b.supportsTurn &&
      this.supportsStun == b.supportsStun &&
      this.username.equalsOrEmpty(b.username) &&
      this.password.equalsOrEmpty(b.password)
    }
    else -> {
      assertCallServerType_569fa9f7()
      throw unsupported(this)
    }
  }
}
...
@Autogenerated
fun CallState?.equalsTo(other: CallState?): Boolean = this.safeEqualsTo(other) { b ->
  when (this.constructor) {
    CallStateExchangingKeys.CONSTRUCTOR,
    CallStateHangingUp.CONSTRUCTOR ->
      true // nothing to compare
    CallStateDiscarded.CONSTRUCTOR -> {
      require(this is CallStateDiscarded && b is CallStateDiscarded)
      if (COMPILE_CHECK) {
        CallStateDiscarded(
          this.reason,
          this.needRating,
      ...
      this.needRating == b.needRating &&
      this.needDebugInformation == b.needDebugInformation &&
      this.needLog == b.needLog &&
      this.reason.equalsTo(b.reason)
    }
    CallStateError.CONSTRUCTOR -> {
      require(this is CallStateError && b is CallStateError)
      if (COMPILE_CHECK) {
        CallStateError(
          this.error
        )
    ...
    CallStatePending.CONSTRUCTOR -> {
      require(this is CallStatePending && b is CallStatePending)
      if (COMPILE_CHECK) {
        CallStatePending(
          this.isCreated,
          this.isReceived
      ...
      this.isCreated == b.isCreated &&
      this.isReceived == b.isReceived
    }
    CallStateReady.CONSTRUCTOR -> {
      require(this is CallStateReady && b is CallStateReady)
      if (COMPILE_CHECK) {
        CallStateReady(
          this.protocol,
          this.servers,
      ...
      this.allowP2p == b.allowP2p &&
      this.isGroupCallSupported == b.isGroupCallSupported &&
      this.protocol.equalsTo(b.protocol) &&
      this.servers.equalsTo(b.servers) &&
      this.config.equalsOrEmpty(b.config) &&
      this.customParameters.equalsOrEmpty(b.customParameters) &&
      this.encryptionKey.contentEqualsOrEmpty(b.encryptionKey) &&
      this.emojis.contentEqualsOrEmpty(b.emojis)
    }
    else -> {
      assertCallState_2604589b()
      throw unsupported(this)
    }
  }
}
...
@Autogenerated
fun CanSendMessageToUserResult?.equalsTo(other: CanSendMessageToUserResult?): Boolean = this.safeEqualsTo(other) { b ->
  when (this.constructor) {
    ...
    CanSendMessageToUserResultUserHasPaidMessages.CONSTRUCTOR -> {
      require(this is CanSendMessageToUserResultUserHasPaidMessages && b is CanSendMessageToUserResultUserHasPaidMessages)
      if (COMPILE_CHECK) {
        CanSendMessageToUserResultUserHasPaidMessages(
          this.outgoingPaidMessageStarCount
        )
      }
      this.outgoingPaidMessageStarCount == b.outgoingPaidMessageStarCount
    }
    else -> {
...
fun ChatActionBar?.equalsTo(other: ChatActionBar?): Boolean = this.safeEqualsTo(other) { b ->
  when (this.constructor) {
    ...
    ChatActionBarReportAddBlock.CONSTRUCTOR -> {
      ...
      this.accountInfo.equalsTo(b.accountInfo)
    }
...
@Autogenerated
fun DateTimeFormattingType?.equalsTo(other: DateTimeFormattingType?): Boolean = this.safeEqualsTo(other) { b ->
  when (this.constructor) {
    DateTimeFormattingTypeRelative.CONSTRUCTOR ->
      true // nothing to compare
    DateTimeFormattingTypeAbsolute.CONSTRUCTOR -> {
      require(this is DateTimeFormattingTypeAbsolute && b is DateTimeFormattingTypeAbsolute)
      if (COMPILE_CHECK) {
      ...
      this.showDayOfWeek == b.showDayOfWeek &&
      this.timePrecision.equalsTo(b.timePrecision) &&
      this.datePrecision.equalsTo(b.datePrecision)
    }
    else -> {
...
@Autogenerated
fun DateTimePartPrecision?.equalsTo(other: DateTimePartPrecision?): Boolean = this.safeEqualsTo(other) { _ ->
  when (this.constructor) {
...
@OptIn(ExperimentalContracts::class)
@Autogenerated
fun DraftMessageContent?.equalsTo(other: DraftMessageContent?): Boolean = this.safeEqualsTo(other) { b ->
  when (this.constructor) {
    DraftMessageContentRichMessage.CONSTRUCTOR -> {
      require(this is DraftMessageContentRichMessage && b is DraftMessageContentRichMessage)
      if (COMPILE_CHECK) {
        DraftMessageContentRichMessage(
          this.message
        )
      }
      this.message.equalsTo(b.message)
    }
    DraftMessageContentText.CONSTRUCTOR -> {
      require(this is DraftMessageContentText && b is DraftMessageContentText)
      if (COMPILE_CHECK) {
    ...
    DraftMessageContentVideoNote.CONSTRUCTOR -> {
      require(this is DraftMessageContentVideoNote && b is DraftMessageContentVideoNote)
      if (COMPILE_CHECK) {
      ...
      this.duration == b.duration &&
      this.length == b.length &&
      this.filePath.equalsOrEmpty(b.filePath) &&
      this.selfDestructType.equalsTo(b.selfDestructType)
    }
    DraftMessageContentVoiceNote.CONSTRUCTOR -> {
      require(this is DraftMessageContentVoiceNote && b is DraftMessageContentVoiceNote)
      if (COMPILE_CHECK) {
...
fun InternalLinkType?.equalsTo(other: InternalLinkType?): Boolean = this.safeEqualsTo(other) { b ->
  when (this.constructor) {
    InternalLinkTypeChatSelection.CONSTRUCTOR,
    InternalLinkTypeNewChannelChat.CONSTRUCTOR,
    ...
    InternalLinkTypeCallsPage.CONSTRUCTOR -> {
      require(this is InternalLinkTypeCallsPage && b is InternalLinkTypeCallsPage)
      if (COMPILE_CHECK) {
        InternalLinkTypeCallsPage(
          this.section
        )
      }
      this.section.equalsOrEmpty(b.section)
    }
    ...
    InternalLinkTypeContactsPage.CONSTRUCTOR -> {
      require(this is InternalLinkTypeContactsPage && b is InternalLinkTypeContactsPage)
      if (COMPILE_CHECK) {
    ...
    InternalLinkTypeDirectMessagesChat.CONSTRUCTOR -> {
      require(this is InternalLinkTypeDirectMessagesChat && b is InternalLinkTypeDirectMessagesChat)
      if (COMPILE_CHECK) {
        InternalLinkTypeDirectMessagesChat(
          this.channelUsername
        )
      }
      this.channelUsername.equalsOrEmpty(b.channelUsername)
    }
    ...
    InternalLinkTypeGiftAuction.CONSTRUCTOR -> {
      require(this is InternalLinkTypeGiftAuction && b is InternalLinkTypeGiftAuction)
      if (COMPILE_CHECK) {
        InternalLinkTypeGiftAuction(
          this.auctionId
        )
      }
      this.auctionId.equalsOrEmpty(b.auctionId)
    }
    InternalLinkTypeGiftCollection.CONSTRUCTOR -> {
      require(this is InternalLinkTypeGiftCollection && b is InternalLinkTypeGiftCollection)
      if (COMPILE_CHECK) {
      ...
      this.giftOwnerUsername.equalsOrEmpty(b.giftOwnerUsername)
    }
    InternalLinkTypeGroupCall.CONSTRUCTOR -> {
      require(this is InternalLinkTypeGroupCall && b is InternalLinkTypeGroupCall)
      if (COMPILE_CHECK) {
    ...
    InternalLinkTypeLiveStory.CONSTRUCTOR -> {
      require(this is InternalLinkTypeLiveStory && b is InternalLinkTypeLiveStory)
      if (COMPILE_CHECK) {
        InternalLinkTypeLiveStory(
          this.storyPosterUsername
        )
      }
      this.storyPosterUsername.equalsOrEmpty(b.storyPosterUsername)
    }
    ...
    InternalLinkTypeMyProfilePage.CONSTRUCTOR -> {
      require(this is InternalLinkTypeMyProfilePage && b is InternalLinkTypeMyProfilePage)
      if (COMPILE_CHECK) {
    ...
    InternalLinkTypeNewStory.CONSTRUCTOR -> {
      require(this is InternalLinkTypeNewStory && b is InternalLinkTypeNewStory)
      if (COMPILE_CHECK) {
        InternalLinkTypeNewStory(
          this.contentType
        )
      }
      this.contentType.equalsTo(b.contentType)
    }
    InternalLinkTypeOauth.CONSTRUCTOR -> {
      require(this is InternalLinkTypeOauth && b is InternalLinkTypeOauth)
      if (COMPILE_CHECK) {
    ...
    InternalLinkTypePremiumFeaturesPage.CONSTRUCTOR -> {
      require(this is InternalLinkTypePremiumFeaturesPage && b is InternalLinkTypePremiumFeaturesPage)
      if (COMPILE_CHECK) {
    ...
    InternalLinkTypePremiumGiftPurchase.CONSTRUCTOR -> {
      require(this is InternalLinkTypePremiumGiftPurchase && b is InternalLinkTypePremiumGiftPurchase)
      if (COMPILE_CHECK) {
    ...
    InternalLinkTypeRequestManagedBot.CONSTRUCTOR -> {
      require(this is InternalLinkTypeRequestManagedBot && b is InternalLinkTypeRequestManagedBot)
      if (COMPILE_CHECK) {
        InternalLinkTypeRequestManagedBot(
          this.managerBotUsername,
          this.suggestedBotUsername,
          this.suggestedBotName
        )
      }
      this.managerBotUsername.equalsOrEmpty(b.managerBotUsername) &&
      this.suggestedBotUsername.equalsOrEmpty(b.suggestedBotUsername) &&
      this.suggestedBotName.equalsOrEmpty(b.suggestedBotName)
    }
    InternalLinkTypeSettings.CONSTRUCTOR -> {
      require(this is InternalLinkTypeSettings && b is InternalLinkTypeSettings)
      if (COMPILE_CHECK) {
        InternalLinkTypeSettings(
          this.section
        )
      }
      this.section.equalsTo(b.section)
    }
    InternalLinkTypeStarPurchase.CONSTRUCTOR -> {
      require(this is InternalLinkTypeStarPurchase && b is InternalLinkTypeStarPurchase)
      if (COMPILE_CHECK) {
    ...
    InternalLinkTypeStoryAlbum.CONSTRUCTOR -> {
      require(this is InternalLinkTypeStoryAlbum && b is InternalLinkTypeStoryAlbum)
      if (COMPILE_CHECK) {
      ...
      this.storyAlbumId == b.storyAlbumId &&
      this.storyAlbumOwnerUsername.equalsOrEmpty(b.storyAlbumOwnerUsername)
    }
    InternalLinkTypeTextCompositionStyle.CONSTRUCTOR -> {
      require(this is InternalLinkTypeTextCompositionStyle && b is InternalLinkTypeTextCompositionStyle)
      if (COMPILE_CHECK) {
        InternalLinkTypeTextCompositionStyle(
          this.styleName
        )
      }
      this.styleName.equalsOrEmpty(b.styleName)
    }
...
fun KeyboardButtonType?.equalsTo(other: KeyboardButtonType?): Boolean = this.safeEqualsTo(other) { b ->
  when (this.constructor) {
    ...
    KeyboardButtonTypeRequestManagedBot.CONSTRUCTOR -> {
      require(this is KeyboardButtonTypeRequestManagedBot && b is KeyboardButtonTypeRequestManagedBot)
      if (COMPILE_CHECK) {
      ...
      this.id == b.id &&
      this.suggestedName.equalsOrEmpty(b.suggestedName) &&
      this.suggestedUsername.equalsOrEmpty(b.suggestedUsername)
    }
    ...
    KeyboardButtonTypeWebApp.CONSTRUCTOR -> {
      ...
      assertKeyboardButtonType_6c566ba1()
      throw unsupported(this)
    }
  }
}
...
fun LinkPreviewType?.equalsTo(other: LinkPreviewType?): Boolean = this.safeEqualsTo(other) { b ->
  when (this.constructor) {
    ...
    LinkPreviewTypeDirectMessagesChat.CONSTRUCTOR -> {
      require(this is LinkPreviewTypeDirectMessagesChat && b is LinkPreviewTypeDirectMessagesChat)
      if (COMPILE_CHECK) {
    ...
    LinkPreviewTypeGiftAuction.CONSTRUCTOR -> {
      require(this is LinkPreviewTypeGiftAuction && b is LinkPreviewTypeGiftAuction)
      if (COMPILE_CHECK) {
      ...
      this.auctionEndDate == b.auctionEndDate &&
      this.gift.equalsTo(b.gift)
    }
    LinkPreviewTypeGiftCollection.CONSTRUCTOR -> {
      require(this is LinkPreviewTypeGiftCollection && b is LinkPreviewTypeGiftCollection)
      if (COMPILE_CHECK) {
        LinkPreviewTypeGiftCollection(
          this.icons
        )
      }
      this.icons.equalsTo(b.icons)
    }
    LinkPreviewTypeLiveStory.CONSTRUCTOR -> {
      require(this is LinkPreviewTypeLiveStory && b is LinkPreviewTypeLiveStory)
      if (COMPILE_CHECK) {
    ...
    LinkPreviewTypeStoryAlbum.CONSTRUCTOR -> {
      require(this is LinkPreviewTypeStoryAlbum && b is LinkPreviewTypeStoryAlbum)
      if (COMPILE_CHECK) {
      ...
      this.photoIcon.equalsTo(b.photoIcon) &&
      this.videoIcon.equalsTo(b.videoIcon)
    }
    ...
    LinkPreviewTypeTextCompositionStyle.CONSTRUCTOR -> {
      require(this is LinkPreviewTypeTextCompositionStyle && b is LinkPreviewTypeTextCompositionStyle)
      if (COMPILE_CHECK) {
...
fun MessageReplyTo?.equalsTo(other: MessageReplyTo?): Boolean = this.safeEqualsTo(other) { b ->
  when (this.constructor) {
    MessageReplyToMessage.CONSTRUCTOR -> {
      ...
      this.pollOptionId.equalsOrEmpty(b.pollOptionId)
...
@Autogenerated
fun MessageTopic?.equalsTo(other: MessageTopic?): Boolean = this.safeEqualsTo(other) { b ->
  when (this.constructor) {
    MessageTopicDirectMessages.CONSTRUCTOR -> {
      require(this is MessageTopicDirectMessages && b is MessageTopicDirectMessages)
      if (COMPILE_CHECK) {
        MessageTopicDirectMessages(
          this.directMessagesChatTopicId
        )
      }
      this.directMessagesChatTopicId == b.directMessagesChatTopicId
    }
    MessageTopicForum.CONSTRUCTOR -> {
      require(this is MessageTopicForum && b is MessageTopicForum)
      if (COMPILE_CHECK) {
        MessageTopicForum(
          this.forumTopicId
        )
      }
      this.forumTopicId == b.forumTopicId
    }
    MessageTopicSavedMessages.CONSTRUCTOR -> {
      require(this is MessageTopicSavedMessages && b is MessageTopicSavedMessages)
      if (COMPILE_CHECK) {
        MessageTopicSavedMessages(
          this.savedMessagesTopicId
        )
      }
      this.savedMessagesTopicId == b.savedMessagesTopicId
    }
    MessageTopicThread.CONSTRUCTOR -> {
      require(this is MessageTopicThread && b is MessageTopicThread)
      if (COMPILE_CHECK) {
        MessageTopicThread(
...
@Autogenerated
fun PageBlock?.equalsTo(other: PageBlock?): Boolean = this.safeEqualsTo(other) { b ->
  when (this.constructor) {
    PageBlockDivider.CONSTRUCTOR ->
      true // nothing to compare
    PageBlockAnchor.CONSTRUCTOR -> {
      require(this is PageBlockAnchor && b is PageBlockAnchor)
      if (COMPILE_CHECK) {
        PageBlockAnchor(
          this.name
        )
    ...
    PageBlockAnimation.CONSTRUCTOR -> {
      require(this is PageBlockAnimation && b is PageBlockAnimation)
      if (COMPILE_CHECK) {
        PageBlockAnimation(
          this.animation,
          this.caption,
      ...
      this.needAutoplay == b.needAutoplay &&
      this.hasSpoiler == b.hasSpoiler &&
      this.animation.equalsTo(b.animation) &&
      this.caption.equalsTo(b.caption)
    }
    PageBlockAudio.CONSTRUCTOR -> {
      require(this is PageBlockAudio && b is PageBlockAudio)
      if (COMPILE_CHECK) {
        PageBlockAudio(
          this.audio,
          this.caption
    ...
    PageBlockAuthorDate.CONSTRUCTOR -> {
      require(this is PageBlockAuthorDate && b is PageBlockAuthorDate)
      if (COMPILE_CHECK) {
        PageBlockAuthorDate(
          this.author,
          this.publishDate
    ...
    PageBlockBlockQuote.CONSTRUCTOR -> {
      require(this is PageBlockBlockQuote && b is PageBlockBlockQuote)
      if (COMPILE_CHECK) {
        PageBlockBlockQuote(
          this.blocks,
          this.credit
    ...
    PageBlockChatLink.CONSTRUCTOR -> {
      require(this is PageBlockChatLink && b is PageBlockChatLink)
      if (COMPILE_CHECK) {
        PageBlockChatLink(
          this.title,
          this.photo,
      ...
      this.accentColorId == b.accentColorId &&
      this.title.equalsOrEmpty(b.title) &&
      this.photo.equalsTo(b.photo) &&
      this.username.equalsOrEmpty(b.username)
    }
    PageBlockCollage.CONSTRUCTOR -> {
      require(this is PageBlockCollage && b is PageBlockCollage)
      if (COMPILE_CHECK) {
        PageBlockCollage(
          this.blocks,
          this.caption
    ...
    PageBlockCover.CONSTRUCTOR -> {
      require(this is PageBlockCover && b is PageBlockCover)
      if (COMPILE_CHECK) {
        PageBlockCover(
          this.cover
        )
    ...
    PageBlockDetails.CONSTRUCTOR -> {
      require(this is PageBlockDetails && b is PageBlockDetails)
      if (COMPILE_CHECK) {
        PageBlockDetails(
          this.header,
          this.blocks,
      ...
      this.header.equalsTo(b.header) &&
      this.blocks.equalsTo(b.blocks)
    }
    PageBlockEmbedded.CONSTRUCTOR -> {
      require(this is PageBlockEmbedded && b is PageBlockEmbedded)
      if (COMPILE_CHECK) {
        PageBlockEmbedded(
          this.url,
          this.html,
      ...
      this.width == b.width &&
      this.height == b.height &&
      this.isFullWidth == b.isFullWidth &&
      this.allowScrolling == b.allowScrolling &&
      this.url.equalsOrEmpty(b.url) &&
      this.html.equalsOrEmpty(b.html) &&
      this.posterPhoto.equalsTo(b.posterPhoto) &&
      this.caption.equalsTo(b.caption)
    }
    PageBlockEmbeddedPost.CONSTRUCTOR -> {
      require(this is PageBlockEmbeddedPost && b is PageBlockEmbeddedPost)
      if (COMPILE_CHECK) {
      ...
      this.url.equalsOrEmpty(b.url) &&
      this.author.equalsOrEmpty(b.author) &&
      this.authorPhoto.equalsTo(b.authorPhoto) &&
      this.blocks.equalsTo(b.blocks) &&
      this.caption.equalsTo(b.caption)
    }
    PageBlockFooter.CONSTRUCTOR -> {
      require(this is PageBlockFooter && b is PageBlockFooter)
      if (COMPILE_CHECK) {
        PageBlockFooter(
          this.footer
        )
      }
      this.footer.equalsTo(b.footer)
    }
    PageBlockHeader.CONSTRUCTOR -> {
      require(this is PageBlockHeader && b is PageBlockHeader)
      if (COMPILE_CHECK) {
        PageBlockHeader(
          this.header
        )
    ...
    PageBlockKicker.CONSTRUCTOR -> {
      require(this is PageBlockKicker && b is PageBlockKicker)
      if (COMPILE_CHECK) {
        PageBlockKicker(
          this.kicker
        )
      }
      this.kicker.equalsTo(b.kicker)
    }
    PageBlockList.CONSTRUCTOR -> {
      require(this is PageBlockList && b is PageBlockList)
      if (COMPILE_CHECK) {
        PageBlockList(
          this.items
        )
      }
      this.items.equalsTo(b.items)
    }
    PageBlockMap.CONSTRUCTOR -> {
      require(this is PageBlockMap && b is PageBlockMap)
      if (COMPILE_CHECK) {
        PageBlockMap(
          this.location,
          this.zoom,
    ...
    PageBlockMathematicalExpression.CONSTRUCTOR -> {
      require(this is PageBlockMathematicalExpression && b is PageBlockMathematicalExpression)
      if (COMPILE_CHECK) {
        PageBlockMathematicalExpression(
          this.expression
        )
      }
      this.expression.equalsOrEmpty(b.expression)
    }
    PageBlockParagraph.CONSTRUCTOR -> {
      require(this is PageBlockParagraph && b is PageBlockParagraph)
      if (COMPILE_CHECK) {
        PageBlockParagraph(
          this.text
        )
    ...
    PageBlockPhoto.CONSTRUCTOR -> {
      require(this is PageBlockPhoto && b is PageBlockPhoto)
      if (COMPILE_CHECK) {
        PageBlockPhoto(
          this.photo,
          this.caption,
    ...
    PageBlockPreformatted.CONSTRUCTOR -> {
      require(this is PageBlockPreformatted && b is PageBlockPreformatted)
      if (COMPILE_CHECK) {
    ...
    PageBlockPullQuote.CONSTRUCTOR -> {
      require(this is PageBlockPullQuote && b is PageBlockPullQuote)
      if (COMPILE_CHECK) {
        PageBlockPullQuote(
          this.text,
          this.credit
    ...
    PageBlockRelatedArticles.CONSTRUCTOR -> {
      require(this is PageBlockRelatedArticles && b is PageBlockRelatedArticles)
      if (COMPILE_CHECK) {
      ...
      this.header.equalsTo(b.header) &&
      this.articles.equalsTo(b.articles)
    }
    PageBlockSectionHeading.CONSTRUCTOR -> {
      require(this is PageBlockSectionHeading && b is PageBlockSectionHeading)
      if (COMPILE_CHECK) {
    ...
    PageBlockSlideshow.CONSTRUCTOR -> {
      require(this is PageBlockSlideshow && b is PageBlockSlideshow)
      if (COMPILE_CHECK) {
        PageBlockSlideshow(
          this.blocks,
          this.caption
    ...
    PageBlockSubheader.CONSTRUCTOR -> {
      require(this is PageBlockSubheader && b is PageBlockSubheader)
      if (COMPILE_CHECK) {
        PageBlockSubheader(
          this.subheader
        )
      }
      this.subheader.equalsTo(b.subheader)
    }
    PageBlockSubtitle.CONSTRUCTOR -> {
      require(this is PageBlockSubtitle && b is PageBlockSubtitle)
      if (COMPILE_CHECK) {
        PageBlockSubtitle(
          this.subtitle
        )
      }
      this.subtitle.equalsTo(b.subtitle)
    }
    PageBlockTable.CONSTRUCTOR -> {
      require(this is PageBlockTable && b is PageBlockTable)
      if (COMPILE_CHECK) {
        PageBlockTable(
          this.caption,
          this.cells,
      ...
      this.isBordered == b.isBordered &&
      this.isStriped == b.isStriped &&
      this.caption.equalsTo(b.caption) &&
      this.cells.equalsTo(b.cells)
    }
    PageBlockThinking.CONSTRUCTOR -> {
      require(this is PageBlockThinking && b is PageBlockThinking)
      if (COMPILE_CHECK) {
        PageBlockThinking(
          this.text
        )
    ...
    PageBlockTitle.CONSTRUCTOR -> {
      require(this is PageBlockTitle && b is PageBlockTitle)
      if (COMPILE_CHECK) {
        PageBlockTitle(
          this.title
        )
      }
      this.title.equalsTo(b.title)
    }
    PageBlockVideo.CONSTRUCTOR -> {
      require(this is PageBlockVideo && b is PageBlockVideo)
      if (COMPILE_CHECK) {
        PageBlockVideo(
          this.video,
          this.caption,
      ...
      this.needAutoplay == b.needAutoplay &&
      this.isLooped == b.isLooped &&
      this.hasSpoiler == b.hasSpoiler &&
      this.video.equalsTo(b.video) &&
      this.caption.equalsTo(b.caption)
    }
    PageBlockVoiceNote.CONSTRUCTOR -> {
      require(this is PageBlockVoiceNote && b is PageBlockVoiceNote)
      if (COMPILE_CHECK) {
        PageBlockVoiceNote(
          this.voiceNote,
          this.caption
...
@Autogenerated
fun PageBlockHorizontalAlignment?.equalsTo(other: PageBlockHorizontalAlignment?): Boolean = this.safeEqualsTo(other) { _ ->
  when (this.constructor) {
    ...
    PageBlockHorizontalAlignmentRight.CONSTRUCTOR ->
      ...
      assertPageBlockHorizontalAlignment_c0d442f9()
      throw unsupported(this)
    }
  }
}
...
@Autogenerated
fun PageBlockVerticalAlignment?.equalsTo(other: PageBlockVerticalAlignment?): Boolean = this.safeEqualsTo(other) { _ ->
  when (this.constructor) {
    ...
    PageBlockVerticalAlignmentTop.CONSTRUCTOR ->
      ...
      assertPageBlockVerticalAlignment_1d620a05()
      throw unsupported(this)
    }
  }
}
...
@Autogenerated
fun PollVoteRestrictionReason?.equalsTo(other: PollVoteRestrictionReason?): Boolean = this.safeEqualsTo(other) { b ->
  when (this.constructor) {
    ...
    PollVoteRestrictionReasonCountryRestricted.CONSTRUCTOR -> {
      require(this is PollVoteRestrictionReasonCountryRestricted && b is PollVoteRestrictionReasonCountryRestricted)
      if (COMPILE_CHECK) {
        PollVoteRestrictionReasonCountryRestricted(
          this.countryCode
        )
      }
      this.countryCode.equalsOrEmpty(b.countryCode)
    }
    PollVoteRestrictionReasonMembershipRequired.CONSTRUCTOR -> {
      require(this is PollVoteRestrictionReasonMembershipRequired && b is PollVoteRestrictionReasonMembershipRequired)
      if (COMPILE_CHECK) {
      ...
      assertPollVoteRestrictionReason_25ecb885()
      throw unsupported(this)
    }
  }
}
...
@Autogenerated
fun RichText?.equalsTo(other: RichText?): Boolean = this.safeEqualsTo(other) { b ->
  when (this.constructor) {
    RichTextAnchor.CONSTRUCTOR -> {
      require(this is RichTextAnchor && b is RichTextAnchor)
      if (COMPILE_CHECK) {
        RichTextAnchor(
          this.name
        )
    ...
    RichTextAnchorLink.CONSTRUCTOR -> {
      require(this is RichTextAnchorLink && b is RichTextAnchorLink)
      if (COMPILE_CHECK) {
        RichTextAnchorLink(
          this.text,
          this.anchorName,
      ...
      this.text.equalsTo(b.text) &&
      this.anchorName.equalsOrEmpty(b.anchorName) &&
      this.url.equalsOrEmpty(b.url)
    }
    RichTextBankCardNumber.CONSTRUCTOR -> {
      require(this is RichTextBankCardNumber && b is RichTextBankCardNumber)
      if (COMPILE_CHECK) {
      ...
      this.text.equalsTo(b.text) &&
      this.bankCardNumber.equalsOrEmpty(b.bankCardNumber)
    }
    RichTextBold.CONSTRUCTOR -> {
      require(this is RichTextBold && b is RichTextBold)
      if (COMPILE_CHECK) {
        RichTextBold(
          this.text
        )
    ...
    RichTextBotCommand.CONSTRUCTOR -> {
      require(this is RichTextBotCommand && b is RichTextBotCommand)
      if (COMPILE_CHECK) {
        RichTextBotCommand(
          this.text,
          this.botCommand
      ...
      this.text.equalsTo(b.text) &&
      this.botCommand.equalsOrEmpty(b.botCommand)
    }
    RichTextCashtag.CONSTRUCTOR -> {
      require(this is RichTextCashtag && b is RichTextCashtag)
      if (COMPILE_CHECK) {
        RichTextCashtag(
          this.text,
          this.cashtag
      ...
      this.text.equalsTo(b.text) &&
      this.cashtag.equalsOrEmpty(b.cashtag)
    }
    RichTextCustomEmoji.CONSTRUCTOR -> {
      require(this is RichTextCustomEmoji && b is RichTextCustomEmoji)
      if (COMPILE_CHECK) {
        RichTextCustomEmoji(
          this.customEmojiId,
      ...
      this.customEmojiId == b.customEmojiId &&
      this.alternativeText.equalsOrEmpty(b.alternativeText)
    }
    RichTextDateTime.CONSTRUCTOR -> {
      require(this is RichTextDateTime && b is RichTextDateTime)
      if (COMPILE_CHECK) {
        RichTextDateTime(
          this.text,
          this.unixTime,
      ...
      this.unixTime == b.unixTime &&
      this.text.equalsTo(b.text) &&
      this.formattingType.equalsTo(b.formattingType)
    }
    RichTextDiff.CONSTRUCTOR -> {
      require(this is RichTextDiff && b is RichTextDiff)
      if (COMPILE_CHECK) {
        RichTextDiff(
          this.text,
          this.oldText
      ...
      this.text.equalsTo(b.text) &&
      this.oldText.equalsTo(b.oldText)
    }
    RichTextEmailAddress.CONSTRUCTOR -> {
      require(this is RichTextEmailAddress && b is RichTextEmailAddress)
      if (COMPILE_CHECK) {
      ...
      this.text.equalsTo(b.text) &&
      this.emailAddress.equalsOrEmpty(b.emailAddress)
    }
    RichTextFixed.CONSTRUCTOR -> {
      require(this is RichTextFixed && b is RichTextFixed)
      if (COMPILE_CHECK) {
        RichTextFixed(
          this.text
        )
    ...
    RichTextHashtag.CONSTRUCTOR -> {
      require(this is RichTextHashtag && b is RichTextHashtag)
      if (COMPILE_CHECK) {
        RichTextHashtag(
          this.text,
          this.hashtag
      ...
      this.text.equalsTo(b.text) &&
      this.hashtag.equalsOrEmpty(b.hashtag)
    }
    RichTextIcon.CONSTRUCTOR -> {
      require(this is RichTextIcon && b is RichTextIcon)
      if (COMPILE_CHECK) {
        RichTextIcon(
          this.document,
          this.width,
    ...
    RichTextItalic.CONSTRUCTOR -> {
      require(this is RichTextItalic && b is RichTextItalic)
      if (COMPILE_CHECK) {
        RichTextItalic(
          this.text
        )
    ...
    RichTextMarked.CONSTRUCTOR -> {
      require(this is RichTextMarked && b is RichTextMarked)
      if (COMPILE_CHECK) {
        RichTextMarked(
          this.text
        )
    ...
    RichTextMathematicalExpression.CONSTRUCTOR -> {
      require(this is RichTextMathematicalExpression && b is RichTextMathematicalExpression)
      if (COMPILE_CHECK) {
    ...
    RichTextMention.CONSTRUCTOR -> {
      require(this is RichTextMention && b is RichTextMention)
      if (COMPILE_CHECK) {
        RichTextMention(
          this.text,
          this.username
    ...
    RichTextMentionName.CONSTRUCTOR -> {
      require(this is RichTextMentionName && b is RichTextMentionName)
      if (COMPILE_CHECK) {
        RichTextMentionName(
          this.text,
          this.userId
    ...
    RichTextPhoneNumber.CONSTRUCTOR -> {
      require(this is RichTextPhoneNumber && b is RichTextPhoneNumber)
      if (COMPILE_CHECK) {
        RichTextPhoneNumber(
          this.text,
          this.phoneNumber
    ...
    RichTextPlain.CONSTRUCTOR -> {
      require(this is RichTextPlain && b is RichTextPlain)
      if (COMPILE_CHECK) {
        RichTextPlain(
          this.text
        )
    ...
    RichTextReference.CONSTRUCTOR -> {
      require(this is RichTextReference && b is RichTextReference)
      if (COMPILE_CHECK) {
        RichTextReference(
          this.name,
          this.text
    ...
    RichTextReferenceLink.CONSTRUCTOR -> {
      require(this is RichTextReferenceLink && b is RichTextReferenceLink)
      if (COMPILE_CHECK) {
      ...
      this.text.equalsTo(b.text) &&
      this.referenceName.equalsOrEmpty(b.referenceName) &&
      this.url.equalsOrEmpty(b.url)
    }
    RichTextSpoiler.CONSTRUCTOR -> {
      require(this is RichTextSpoiler && b is RichTextSpoiler)
      if (COMPILE_CHECK) {
        RichTextSpoiler(
          this.text
        )
    ...
    RichTextStrikethrough.CONSTRUCTOR -> {
      require(this is RichTextStrikethrough && b is RichTextStrikethrough)
      if (COMPILE_CHECK) {
    ...
    RichTextSubscript.CONSTRUCTOR -> {
      require(this is RichTextSubscript && b is RichTextSubscript)
      if (COMPILE_CHECK) {
        RichTextSubscript(
          this.text
        )
    ...
    RichTextSuperscript.CONSTRUCTOR -> {
      require(this is RichTextSuperscript && b is RichTextSuperscript)
      if (COMPILE_CHECK) {
        RichTextSuperscript(
          this.text
        )
    ...
    RichTextUnderline.CONSTRUCTOR -> {
      require(this is RichTextUnderline && b is RichTextUnderline)
      if (COMPILE_CHECK) {
        RichTextUnderline(
          this.text
        )
    ...
    RichTextUrl.CONSTRUCTOR -> {
      require(this is RichTextUrl && b is RichTextUrl)
      if (COMPILE_CHECK) {
        RichTextUrl(
          this.text,
          this.url,
      ...
      this.isCached == b.isCached &&
      this.text.equalsTo(b.text) &&
      this.url.equalsOrEmpty(b.url)
    }
    RichTexts.CONSTRUCTOR -> {
      require(this is RichTexts && b is RichTexts)
      if (COMPILE_CHECK) {
        RichTexts(
          this.texts
        )
      }
      this.texts.equalsTo(b.texts)
    }
    else -> {
...
@Autogenerated
fun SettingsSection?.equalsTo(other: SettingsSection?): Boolean = this.safeEqualsTo(other) { b ->
  when (this.constructor) {
    SettingsSectionAskQuestion.CONSTRUCTOR,
    SettingsSectionFaq.CONSTRUCTOR,
    SettingsSectionFeatures.CONSTRUCTOR,
    SettingsSectionMyGrams.CONSTRUCTOR,
    SettingsSectionPremium.CONSTRUCTOR,
    SettingsSectionPrivacyPolicy.CONSTRUCTOR,
    SettingsSectionSearch.CONSTRUCTOR ->
      true // nothing to compare
    SettingsSectionAppearance.CONSTRUCTOR -> {
      require(this is SettingsSectionAppearance && b is SettingsSectionAppearance)
      if (COMPILE_CHECK) {
        SettingsSectionAppearance(
          this.subsection
        )
      }
      this.subsection.equalsOrEmpty(b.subsection)
    }
    SettingsSectionBusiness.CONSTRUCTOR -> {
      require(this is SettingsSectionBusiness && b is SettingsSectionBusiness)
      if (COMPILE_CHECK) {
    ...
    SettingsSectionChatFolders.CONSTRUCTOR -> {
      require(this is SettingsSectionChatFolders && b is SettingsSectionChatFolders)
      if (COMPILE_CHECK) {
    ...
    SettingsSectionDataAndStorage.CONSTRUCTOR -> {
      require(this is SettingsSectionDataAndStorage && b is SettingsSectionDataAndStorage)
      if (COMPILE_CHECK) {
    ...
    SettingsSectionDevices.CONSTRUCTOR -> {
      require(this is SettingsSectionDevices && b is SettingsSectionDevices)
      if (COMPILE_CHECK) {
    ...
    SettingsSectionEditProfile.CONSTRUCTOR -> {
      require(this is SettingsSectionEditProfile && b is SettingsSectionEditProfile)
      if (COMPILE_CHECK) {
    ...
    SettingsSectionInAppBrowser.CONSTRUCTOR -> {
      require(this is SettingsSectionInAppBrowser && b is SettingsSectionInAppBrowser)
      if (COMPILE_CHECK) {
    ...
    SettingsSectionLanguage.CONSTRUCTOR -> {
      require(this is SettingsSectionLanguage && b is SettingsSectionLanguage)
      if (COMPILE_CHECK) {
    ...
    SettingsSectionMyStars.CONSTRUCTOR -> {
      require(this is SettingsSectionMyStars && b is SettingsSectionMyStars)
      if (COMPILE_CHECK) {
    ...
    SettingsSectionNotifications.CONSTRUCTOR -> {
      require(this is SettingsSectionNotifications && b is SettingsSectionNotifications)
      if (COMPILE_CHECK) {
    ...
    SettingsSectionPowerSaving.CONSTRUCTOR -> {
      require(this is SettingsSectionPowerSaving && b is SettingsSectionPowerSaving)
      if (COMPILE_CHECK) {
    ...
    SettingsSectionPrivacyAndSecurity.CONSTRUCTOR -> {
      require(this is SettingsSectionPrivacyAndSecurity && b is SettingsSectionPrivacyAndSecurity)
      if (COMPILE_CHECK) {
    ...
    SettingsSectionQrCode.CONSTRUCTOR -> {
      require(this is SettingsSectionQrCode && b is SettingsSectionQrCode)
      if (COMPILE_CHECK) {
    ...
    SettingsSectionSendGift.CONSTRUCTOR -> {
      require(this is SettingsSectionSendGift && b is SettingsSectionSendGift)
      if (COMPILE_CHECK) {
      ...
      assertSettingsSection_c6f544dd()
      throw unsupported(this)
    }
  }
}
...
@Autogenerated
fun StoryContentType?.equalsTo(other: StoryContentType?): Boolean = this.safeEqualsTo(other) { _ ->
  when (this.constructor) {
    StoryContentTypeLive.CONSTRUCTOR,
    StoryContentTypePhoto.CONSTRUCTOR,
    StoryContentTypeUnsupported.CONSTRUCTOR,
    StoryContentTypeVideo.CONSTRUCTOR ->
      true // nothing to compare
    else -> {
      assertStoryContentType_ab4df18c()
      throw unsupported(this)
    }
  }
}
...
fun SuggestedAction?.equalsTo(other: SuggestedAction?): Boolean = this.safeEqualsTo(other) { b ->
  when (this.constructor) {
    SuggestedActionAddLoginPasskey.CONSTRUCTOR,
    ...
    SuggestedActionCustom.CONSTRUCTOR -> {
      require(this is SuggestedActionCustom && b is SuggestedActionCustom)
      if (COMPILE_CHECK) {
    ...
    SuggestedActionSetLoginEmailAddress.CONSTRUCTOR -> {
      require(this is SuggestedActionSetLoginEmailAddress && b is SuggestedActionSetLoginEmailAddress)
      if (COMPILE_CHECK) {
        SuggestedActionSetLoginEmailAddress(
          this.canBeHidden
        )
      }
      this.canBeHidden == b.canBeHidden
    }
...
fun TextEntityType?.equalsTo(other: TextEntityType?): Boolean = this.safeEqualsTo(other) { b ->
  when (this.constructor) {
    ...
    TextEntityTypeDateTime.CONSTRUCTOR -> {
      require(this is TextEntityTypeDateTime && b is TextEntityTypeDateTime)
      if (COMPILE_CHECK) {
...
@Autogenerated
fun UpgradedGiftAttributeRarity?.equalsTo(other: UpgradedGiftAttributeRarity?): Boolean = this.safeEqualsTo(other) { b ->
  when (this.constructor) {
    UpgradedGiftAttributeRarityEpic.CONSTRUCTOR,
    UpgradedGiftAttributeRarityLegendary.CONSTRUCTOR,
    UpgradedGiftAttributeRarityRare.CONSTRUCTOR,
    UpgradedGiftAttributeRarityUncommon.CONSTRUCTOR ->
      true // nothing to compare
    UpgradedGiftAttributeRarityPerMille.CONSTRUCTOR -> {
      require(this is UpgradedGiftAttributeRarityPerMille && b is UpgradedGiftAttributeRarityPerMille)
      if (COMPILE_CHECK) {
        UpgradedGiftAttributeRarityPerMille(
          this.perMille
        )
      }
      this.perMille == b.perMille
    }
    else -> {
      assertUpgradedGiftAttributeRarity_23ca7218()
      throw unsupported(this)
    }
  }
}
