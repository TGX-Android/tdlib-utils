...
@Autogenerated fun assertInternalLinkType_91894cfa (): InternalLinkType? = null // ActiveSessions, AttachmentMenuBot, AuthenticationCode, Background, BotAddToChannel, BotStart, BotStartInGroup, ChangePhoneNumber, ChatBoost, ChatFolderInvite, ChatFolderSettings, ChatInvite, DefaultMessageAutoDeleteTimerSettings, EditProfileSettings, Game, InstantView, Invoice, LanguagePack, LanguageSettings, Message, MessageDraft, PassportDataRequest, PhoneNumberConfirmation, PremiumFeatures, PremiumGiftCode, PrivacyAndSecuritySettings, Proxy, PublicChat, QrCodeAuthentication, RestorePurchases, Settings, SideMenuBot, StickerSet, Story, Theme, ThemeSettings, UnknownDeepLink, UnsupportedProxy, UserPhoneNumber, UserToken, VideoChat, WebApp
...
@Autogenerated fun assertMessageContent_afad899a (): MessageContent? = null // MessageAnimatedEmoji, MessageAnimation, MessageAudio, MessageBasicGroupChatCreate, MessageBotWriteAccessAllowed, MessageCall, MessageChatAddMembers, MessageChatChangePhoto, MessageChatChangeTitle, MessageChatDeleteMember, MessageChatDeletePhoto, MessageChatJoinByLink, MessageChatJoinByRequest, MessageChatSetBackground, MessageChatSetMessageAutoDeleteTime, MessageChatSetTheme, MessageChatShared, MessageChatUpgradeFrom, MessageChatUpgradeTo, MessageContact, MessageContactRegistered, MessageCustomServiceAction, MessageDice, MessageDocument, MessageExpiredPhoto, MessageExpiredVideo, MessageForumTopicCreated, MessageForumTopicEdited, MessageForumTopicIsClosedToggled, MessageForumTopicIsHiddenToggled, MessageGame, MessageGameScore, MessageGiftedPremium, MessageInviteVideoChatParticipants, MessageInvoice, MessageLocation, MessagePassportDataReceived, MessagePassportDataSent, MessagePaymentSuccessful, MessagePaymentSuccessfulBot, MessagePhoto, MessagePinMessage, MessagePoll, MessagePremiumGiftCode, MessagePremiumGiveaway, MessagePremiumGiveawayCompleted, MessagePremiumGiveawayCreated, MessageProximityAlertTriggered, MessageScreenshotTaken, MessageSticker, MessageStory, MessageSuggestProfilePhoto, MessageSupergroupChatCreate, MessageText, MessageUnsupported, MessageUserShared, MessageVenue, MessageVideo, MessageVideoChatEnded, MessageVideoChatScheduled, MessageVideoChatStarted, MessageVideoNote, MessageVoiceNote, MessageWebAppDataReceived, MessageWebAppDataSent
...
@Autogenerated fun assertStoryPublicForward_7b31b2ff (): StoryPublicForward? = null // Message, Story
