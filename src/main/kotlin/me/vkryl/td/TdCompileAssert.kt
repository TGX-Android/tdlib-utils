...
@Autogenerated fun assertPremiumFeature_3d71103f (): PremiumFeature? = null // AccentColor, AdvancedChatManagement, AnimatedProfilePhoto, AppIcons, BackgroundForBoth, ChatBoost, CustomEmoji, DisabledAds, EmojiStatus, ForumTopicIcon, ImprovedDownloadSpeed, IncreasedLimits, IncreasedUploadFileSize, LastSeenTimes, MessagePrivacy, ProfileBadge, RealTimeChatTranslation, SavedMessagesTags, UniqueReactions, UniqueStickers, UpgradedStories, VoiceRecognition
...
@Autogenerated fun assertSuggestedAction_45d3774f (): SuggestedAction? = null // CheckPassword, CheckPhoneNumber, ConvertToBroadcastGroup, EnableArchiveAndMuteNewChats, GiftPremiumForChristmas, RestorePremium, SetPassword, SubscribeToAnnualPremium, UpgradePremium, ViewChecksHint
