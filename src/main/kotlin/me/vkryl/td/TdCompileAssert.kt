...
@Autogenerated fun assertMessageContent_ea2cfacf (): MessageContent? = null // MessageAnimatedEmoji, MessageAnimation, MessageAudio, MessageBasicGroupChatCreate, MessageBotWriteAccessAllowed, MessageCall, MessageChatAddMembers, MessageChatChangePhoto, MessageChatChangeTitle, MessageChatDeleteMember, MessageChatDeletePhoto, MessageChatJoinByLink, MessageChatJoinByRequest, MessageChatSetBackground, MessageChatSetMessageAutoDeleteTime, MessageChatSetTheme, MessageChatShared, MessageChatUpgradeFrom, MessageChatUpgradeTo, MessageContact, MessageContactRegistered, MessageCustomServiceAction, MessageDice, MessageDocument, MessageExpiredPhoto, MessageExpiredVideo, MessageForumTopicCreated, MessageForumTopicEdited, MessageForumTopicIsClosedToggled, MessageForumTopicIsHiddenToggled, MessageGame, MessageGameScore, MessageGiftedPremium, MessageInviteVideoChatParticipants, MessageInvoice, MessageLocation, MessagePassportDataReceived, MessagePassportDataSent, MessagePaymentSuccessful, MessagePaymentSuccessfulBot, MessagePhoto, MessagePinMessage, MessagePoll, MessagePremiumGiftCode, MessagePremiumGiveaway, MessagePremiumGiveawayCreated, MessageProximityAlertTriggered, MessageScreenshotTaken, MessageSticker, MessageStory, MessageSuggestProfilePhoto, MessageSupergroupChatCreate, MessageText, MessageUnsupported, MessageUserShared, MessageVenue, MessageVideo, MessageVideoChatEnded, MessageVideoChatScheduled, MessageVideoChatStarted, MessageVideoNote, MessageVoiceNote, MessageWebAppDataReceived, MessageWebAppDataSent
...
@Autogenerated fun assertPremiumFeature_76ab446 (): PremiumFeature? = null // AccentColor, AdvancedChatManagement, AnimatedProfilePhoto, AppIcons, ChatBoost, CustomEmoji, DisabledAds, EmojiStatus, ForumTopicIcon, ImprovedDownloadSpeed, IncreasedLimits, IncreasedUploadFileSize, ProfileBadge, RealTimeChatTranslation, UniqueReactions, UniqueStickers, UpgradedStories, VoiceRecognition
