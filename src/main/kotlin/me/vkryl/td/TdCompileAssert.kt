...
@Autogenerated fun assertPremiumFeature_3d33c80d (): PremiumFeature? = null // AccentColor, AdvancedChatManagement, AnimatedProfilePhoto, AppIcons, BackgroundForBoth, ChatBoost, CustomEmoji, DisabledAds, EmojiStatus, ForumTopicIcon, ImprovedDownloadSpeed, IncreasedLimits, IncreasedUploadFileSize, ProfileBadge, RealTimeChatTranslation, UniqueReactions, UniqueStickers, UpgradedStories, VoiceRecognition
...
@Autogenerated fun assertSavedMessagesTopic_ca86026f (): SavedMessagesTopic? = null // AuthorHidden, MyNotes, SavedFromChat
